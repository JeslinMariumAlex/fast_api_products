...
products = [
    Product(id=1, name="Laptop", price=999.99, description="A high-end laptop", quantity=10),
    ...
    Product(id=5, name="Monitor", price=299.99, description="4K UHD Monitor", quantity=8)
]
